...
for definition in definitions:
    ...
    for def_cn_tag in def_cn_tags:
        # # 英文部分是紧跟在类型之后的文字
        # en_def = def_cn_tag.next_sibling.strip()
        # print(f"英文解释: {en_def}")
        # # 中文部分包含在<span class="chinese-text">...</span>内
        # zh_def = def_cn_tag.find('span', {'class': 'chinese-text'}).get_text(strip=True)
        # print(f"中文翻译: {zh_def}")
...
for info in extracted_info:
    print(f"{info['type']} {info['zh_definition']} {info['en_definition']}")